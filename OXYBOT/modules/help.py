...
HELP_BUTTON = [
    ...
    [
      Button.url("★𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗥★", "https://t.me/THE_ALPHA_BOY"),
...
async def helpback(event):
    if event.query.user_id in SUDO_USERS:    
        ...
        await event.answer("★𝐏𝐋𝐄𝐀𝐒𝐄 𝐉𝐎𝐈𝐍 𝐒𝐔𝐏𝐏𝐎𝐑𝐓 𝐆𝐑𝐎𝐔𝐏 𝐀𝐍𝐃 𝐓𝐀𝐆 @THE_ALPHA_BOY★" , cache_time=0, alert=True)
